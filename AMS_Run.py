...
def SendMail():
    ...
    filename = "English_2022-03-31_20-56-29.csv"
    attachment = open("Attendance/English_2022-03-31_20-56-29.csv", "rb")
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer \select,"mini project\mini project\-------Check atttendance-------"')
...
FA1 = tk.Button(window, text="Send Mail",fg="white",command=SendMail  ,bg="blue2"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
FA1.place(x=990, y=500)
